...
class RWDP_My_Account_Widget extends \Elementor\Widget_Base {
	...
	protected function render() {
		echo rwdp_my_account_shortcode( $this->get_settings_for_display() ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- output escaping handled within the shortcode function
	}
}
